...
public class PickerManager {
    private static final PickerManager ourInstance = new PickerManager();
    ...
    private final ArrayList<String> mediaFiles;
    private final ArrayList<String> docFiles;

    private final LinkedHashSet<FileType> fileTypes;
